...
@php
	...
	if (auth('empleado')->check()){
		$nombreUsuario =  auth('empleado')->user()->nombres . " " . auth('empleado')->user()->apellidos ;
		$id_usuario =  auth('empleadp')->user()->id_empleado;
		$c = App\Modelo\Empleado::where('id_empleado',$id_usuario)->first();
	}   
